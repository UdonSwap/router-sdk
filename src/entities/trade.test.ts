...
describe('Trade', () => {
  ...
  describe('#worstExecutionPrice', () => {
    ...
    //     expect(exactIn.worstExecutionPrice(new Percent(5, 100))).toEqual(new Price(token0, token2, 163, 100))
    //     expect(exactIn.worstExecutionPrice(new Percent(200, 100))).toEqual(new Price(token0, token2, 468, 100))
    //   })
    // })  
  ...
  //         CurrencyAmount.fromRawAmount(token1, 95) // 300 * 0.95
  //       )
  ...
  //       it('returns exact if nonzero', () => {
  //         expect(trade.minimumAmountOut(new Percent(JSBI.BigInt(5), 100))).toEqual(
  //           CurrencyAmount.fromRawAmount(token1, 105)
  //         )
  //       })
  //     })
  //   })

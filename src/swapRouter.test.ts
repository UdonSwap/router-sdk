import { BigintIsh, CurrencyAmount, Ether, Percent, Token, TradeType, WETH9 } from 'udonswap-sdk-core'
import { Pair, Route as V2Route, Trade as V2Trade } from 'udonswap-v2'
import {
  encodeSqrtRatioX96,
  FeeAmount,
  nearestUsableTick,
